      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">*We will have the ltest news and updates in the fitness world please subscribe for frequent updates.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2021 MonsterGYM. Brought To You By <a>AFHS</a></p>
        </div>
      </div>
    </div>
  </div>
